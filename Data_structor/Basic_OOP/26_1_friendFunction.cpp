...
class Complex{
    ...
    public:
        ...
        //Below line means that non member - sumComplesx function is allowed to do 
        //anything with my private variable(member)
...
6. It cannot access the member directly by their names and need object_name.member_name
